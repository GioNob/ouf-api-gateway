...
INTERNAL_ISSUER_HOST="${OUF_INTERNAL_ISSUER_HOST:?OUF_INTERNAL_ISSUER_HOST is required}"
INTERNAL_API_HOST="${OUF_INTERNAL_API_HOST:?OUF_INTERNAL_API_HOST is required}"
...
OIDC_DISCOVERY_URL="${OUF_OIDC_DISCOVERY_URL:-https://${INTERNAL_ISSUER_HOST}/realms/ouf/.well-known/openid-configuration}"
