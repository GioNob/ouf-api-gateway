...
local receipt = {v=1,purpose='managed-file-owner',method='POST',
    path='/api/internal/v1/onboarding/managed-file-mcp/'..name,bodyHash=body_hash,
...
local signed = hmac and hmac:final('ouf-managed-file-owner-v1.'..encoded)
